...
-- acrowdmap.draw_tools.addNewWindow("testowo", "Titlek 1", 10, 10, 400, 400, true, "")
-- acrowdmap.draw_tools.addNewWindow("testowo2", "Titlek 2", 0, 0, 200, 200, false, uniWindowsTable.testowo.content)

-- acrowdmap.draw_tools.addNewIcon("icon1", 120, 420, 123, 115, "test", 20, 20, 26, "white", "AlignLeft", "AlignVCenter", "btn-map.png", "btn-map-hover.png", container, function() cecho("tescik4\n") end)
-- acrowdmap.draw_tools.addNewIcon("icon2", 300, 20, 123, 115, "test2", 0, 0, 18, "#cccccc", "AlignHCenter", "AlignVCenter", "btn-map.png", "btn-map-hover.png", tempContainer, iconClickCallback)
